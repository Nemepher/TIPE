...
\end{frame}
\begin{frame}
	\centering{\large{Insezrer la problematiqeu}} 
	\tableofcontents
\end{frame}
...
\begin{frame}
	\begin{figure}
		\subfloat[Réponse à une marche\label{fig:a}]{\scalebox{0.3}{\input{fig1.pgf}}}
		\subfloat[Réponse à un créneau pour $\sigma=1$, $\sigma=2$ et $\sigma=3$ \label{fig:b}]{\scalebox{0.3}{\input{fig2.pgf}}}
		\caption{Réponse de l'opérateur LoG à différents signaux}
	\end{figure}
\end{frame}
\begin{frame}
	\begin{figure}
		\subfloat[Réponses à des créneaux pour $\sigma=1$\label{fig:c}]{\scalebox{0.3}{\input{fig3.pgf}}}
		\caption{Réponse de l'opérateur LoG à différents signaux}
	\end{figure}
\end{frame}
...
\begin{frame}
	\begin{figure}
		\subfloat[Example de pyramide d'image, Original, CC BY-SA 1.0]{\includegraphics[scale=0.15]{img.png}}
