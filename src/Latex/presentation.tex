...
\end{frame}
\begin{frame}
	\centering{\large{Dans quelle mesure la recherche d'extremums permet-elle de détecter simultanément des espèces variées d'arbres à partir d'imagerie haute résolution. Et est-il possible de les classifier à l'aide d'un réseau de neurone entraîné avec peu d'images ou des images de faible résolution ?	}} 
	\tableofcontents
\end{frame}
