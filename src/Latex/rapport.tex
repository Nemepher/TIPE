...
\section{Détection des houppiers}
	...
	L'image original est lissée de manière répété au moyen d'un filtre gaussien aux propriété de lissage exceptionnelles pour générer la pyramide d'échelle qui sera exploitée ultérieurement. (Voir figure 2)\\
...
\bibliography{src/Latex/references.bib}
